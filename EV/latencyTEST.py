...
TIMEOUT=30 # Websocket Timeout 
PINGS=999 # Crop validated list prior to use
CROP=999 # Crop final unique list
...
def global_lists():
    ...
    only = ['wss://restricted.bitshares.apasia.tech/ws']
