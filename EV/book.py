...
def verify_book():
    ...
    while True:
            ...
            for i in range(len(node_list)):
                ...
                if (len(book_list) < NODES) and not triplicate:
                    try:
                        ...
                        def fuck_book():
                            ret['askp'] = [satoshi((0.99 + 0.02 * random()) * i)
                                           for i in ret['askp']]
                            ret['bidp'] = [satoshi((1.01 - 0.02 * random()) * i)
                                           for i in ret['bidp']]
                            return ret
                        if FUCK_BOOK:
            ...
            if triplicate == 0:
                ...
                try:
                    ...
                    # RECONSTRUCTED
                        ...
                        z = len(
                            prices)  # will except if odd... shouldn't be, so let it fail
            ...
            if 1:
                pass  #NO BLACKLIST CAPABILITY YET, JUST FRAMEWORK BELOW
            else:
