...
def version():
    ...
    VERSION = 'metaNODE v0.00000003 - Bitshares Trustless Client'
...
def precision(x,n):
    ...
    # returns rounded string representation of float to n decimal places
...
def banner():
    ...
    ''')
    time.sleep(0.5)
    print("    metaNODE['last']      # float; latest price")
    time.sleep(0.5)
    print("    metaNODE['bids']      # list of (price,amount) tuples; [0][0]=highest bid price")
    time.sleep(0.5)
    print("    metaNODE['asks']      # list of (price,amount) tuples; [0][0]=lowest ask price")
    time.sleep(0.5)
    print("    metaNODE['history']   # list of (unix,price,amount) tuples; [0][0]=last trade time")
    time.sleep(0.5)
    print("    metaNODE['currency']  # float; quantity of currency")
    time.sleep(0.5)
    print("    metaNODE['assets']    # float; quantity of assets")
    time.sleep(0.5)
    print("    metaNODE['whitelist'] # list; [0]=most recently whitelisted node")
    time.sleep(0.5)
    print("    metaNODE['blacklist'] # list; [0]=most recently blacklisted node")
    time.sleep(0.5)
    print("    metaNODE['orders']    # list; open order_id's (...orders coming soon...)")
    time.sleep(2)
...
'"get_ticker",["%s","%s","%s"]]}' % (currency, asset, False)
'"get_trade_history",["%s","%s","%s","%s","%s"]]}' % (currency, asset, now, then, limit)
'"get_named_account_balances",["%s", ["%s","%s"]]]}' % (account_name, currency_id, asset_id)
'"get_order_book",["%s","%s","%s"]]}' % (currency, asset, limit)
'''
